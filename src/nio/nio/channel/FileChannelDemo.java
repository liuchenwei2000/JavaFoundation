 ...
 * <p>
 * Reader和Writer的字符模式类不能用于产生通道，但是java.nio.channels.Channels 
 * 类能提供实用方法，用以在通道中产生Reader和Writer。
 * 
 * @author 刘晨伟
 *
 * 创建日期：2009-7-23
...
public class FileChannelDemo {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * 一旦如此，就不再复制底层的数组，而是把它作为所产生的ByteBuffer的存储器
		 * 称之为数组支持的 ByteBuffer
		 */
		 ...
		 * 实际上，这里使用的1K可能比通常应该使用的要小一点(必须通过实际运行我们的应用来找到最佳尺寸)
		 * 也可以使用 allocateDirect() 而不是 allocate()来获取更快的速度
		 * 用于产生一个在更高层次上耦合操作系统的"直接"缓冲器"
