 ...
 * transient关键字演示类
 * <p>
 * 当对序列化进行控制时，可能存在某个特定子对象不想让Java的序列化机制自动保存与恢复。
 * 如果子对象表示的是不希望将其序列化的敏感信息(如密码)，通常就会面临这种情况，
 ...
 * 为了能够予以控制，可以用transient(瞬时)关键字逐个域地关闭序列化。
 * 它的意思是"不用麻烦你保存或恢复数据--我自己会处理的"。
 * <p>
 * 由于Externalizable对象在缺省情况下不保存它们的任何字段，
...
public class TransientDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		in.close();
		System.out.println("读取存储序列化对象文件生成的对象：");
		System.out.println(logInfo.toString());
	}
}
